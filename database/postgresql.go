...
const (
	...
	createMissingOriginsQuery = `INSERT INTO "remote_data" ("origin", "start", "end") SELECT DISTINCT "origin", $1::timestamptz, $2::timestamptz FROM "mapped_data" WHERE "origin" NOT IN (SELECT "origin" FROM "remote_data")`
