...
func init() {
	...
	writeDatabaseRawCmd.Flags().StringSliceVarP(&subscribeURLs, "subscribeURL", "s", []string{}, "Nanomsg URL, the URL is used to listen for subscribed data. May be repeated to subscribe to several publishers at once.")
	writeDatabaseRawCmd.MarkFlagRequired("subscribeURL")
	writeDatabaseCmd.AddCommand(writeDatabaseMappedCmd)
	writeDatabaseMappedCmd.Flags().StringSliceVarP(&subscribeURLs, "subscribeURL", "s", []string{}, "Nanomsg URL, the URL is used to listen for subscribed data. May be repeated to subscribe to several publishers at once.")
	writeDatabaseMappedCmd.MarkFlagRequired("subscribeURL")

	writeCmd.AddCommand(writeMQTTCmd)
	writeMQTTCmd.Flags().StringSliceVarP(&subscribeURLs, "subscribeURL", "s", []string{}, "Nanomsg URL, the URL is used to listen for subscribed data. May be repeated to subscribe to several publishers at once.")
	writeMQTTCmd.MarkFlagRequired("subscribeURL")

	writeCmd.AddCommand(writeSignalKCmd)
	writeSignalKCmd.Flags().StringSliceVarP(&subscribeURLs, "subscribeURL", "s", []string{}, "Nanomsg URL, the URL is used to listen for subscribed data. May be repeated to subscribe to several publishers at once.")
	...
	writeStdOutRawCmd.Flags().StringSliceVarP(&subscribeURLs, "subscribeURL", "s", []string{}, "Nanomsg URL, the URL is used to listen for subscribed data. May be repeated to subscribe to several publishers at once.")
	writeStdOutRawCmd.MarkFlagRequired("subscribeURL")
	writeStdOutCmd.AddCommand(writeStdOutRawStringCmd)
	writeStdOutRawStringCmd.Flags().StringSliceVarP(&subscribeURLs, "subscribeURL", "s", []string{}, "Nanomsg URL, the URL is used to listen for subscribed data. May be repeated to subscribe to several publishers at once.")
	writeStdOutRawStringCmd.MarkFlagRequired("subscribeURL")
	writeStdOutCmd.AddCommand(writeStdOutMappedCmd)
	writeStdOutMappedCmd.Flags().StringSliceVarP(&subscribeURLs, "subscribeURL", "s", []string{}, "Nanomsg URL, the URL is used to listen for subscribed data. May be repeated to subscribe to several publishers at once.")
	writeStdOutMappedCmd.MarkFlagRequired("subscribeURL")

	writeCmd.AddCommand(writeLWECmd)
	writeLWECmd.Flags().StringSliceVarP(&subscribeURLs, "subscribeURL", "s", []string{}, "Nanomsg URL, the URL is used to listen for subscribed data. May be repeated to subscribe to several publishers at once.")
	writeLWECmd.MarkFlagRequired("subscribeURL")

	writeCmd.AddCommand(writeGrafanaCmd)
	writeGrafanaCmd.Flags().StringSliceVarP(&subscribeURLs, "subscribeURL", "s", []string{}, "Nanomsg URL, the URL is used to listen for subscribed data. May be repeated to subscribe to several publishers at once.")
